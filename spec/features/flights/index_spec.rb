...
RSpec.describe "the flights index page" do
  ...
  it "has a link to remove a passenger from a flight" do
    ...
    expect(page).to have_button("Remove", :count => 7)
  end

  it "removes a passenger from a flight when the button is clicked" do
    southwest = Airline.create!(name: "Southwest")
    lufthansa = Airline.create!(name: "Lufthansa")
